...
_STRINGS_ENCODING :: V.Bytes
_STRINGS_ENCODING = "utf-8" :: V.Bytes
...
_DEFAULT_USERNAME :: V.Bytes
_DEFAULT_USERNAME = "default" :: V.Bytes

{-# INLINE _DEFAULT_HOST_NAME #-}
_DEFAULT_HOST_NAME :: V.Bytes
_DEFAULT_HOST_NAME = "localhost" :: V.Bytes

{-# INLINE _DEFAULT_PASSWORD #-}
_DEFAULT_PASSWORD :: V.Bytes
_DEFAULT_PASSWORD = "" :: V.Bytes

{-# INLINE _DEFAULT_PORT_NAME #-}
_DEFAULT_PORT_NAME :: V.Bytes
_DEFAULT_PORT_NAME = "9000" :: V.Bytes

{-# INLINE _DEFAULT_DATABASE #-}
_DEFAULT_DATABASE :: V.Bytes
_DEFAULT_DATABASE = "default" :: V.Bytes
